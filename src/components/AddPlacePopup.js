  ...
  return (
    <PopupWithForm title="Новое место" name="place" buttonText="Создать" buttonDisabled={false} buttonClass="" isOpened={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit}>
      <label className="input__label">
        <input id="place-input" type="text" className="input__text input__text_type_place-title" placeholder="Название" name="place-title" minLength="1" maxLength="30" required  onChange={handleNameChange} value={name}/>
